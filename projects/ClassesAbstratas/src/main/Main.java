...
public class Main {
    ...
    public static void aulaHeranca(){
        ...
        System.out.println("\nDigite o salario:");
        salario = scNumber.nextFloat();
        
        System.out.println("\nDigite o número de funcionários:");
        numeroFuncionarios = scNumber.nextInt();
        
        System.out.println("\nDigite o percentual de aumento:");
        percAumento = scNumber.nextFloat();
        
        Gerente gerente = new Gerente(nome, salario, numeroFuncionarios);
        gerente.aumentarSalario(percAumento);
        
        System.out.println("\n" + gerente.imprimir());
    }
    
    public static void gerenciarIPVA() {
        IPVA ipva = new IPVA(25000, 2);
        
        System.out.println(String.format("Valor do IPVA: R$ %,.2f", ipva.calcularIPVA()));
        System.out.println(ipva.imprimir());
        
        IPVACaminhao ipvaCaminhao = new IPVACaminhao(25000, 2, 2);
        
        System.out.println(String.format("\nValor do IPVA do caminhão: R$ %,.2f", ipvaCaminhao.calcularIPVA()));
        System.out.println(ipvaCaminhao.imprimir());
    }
    
    public static void aulaAbstractClass() {
